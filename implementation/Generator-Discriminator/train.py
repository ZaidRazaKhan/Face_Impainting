...
dataloader = DataLoader(ImageDataset("../../data/img_align_celeba/data/%s" % opt.dataset_name, transforms_=transforms_),
                        batch_size=opt.batch_size, shuffle=True, num_workers=opt.n_cpu)
test_dataloader = DataLoader(ImageDataset("../../data/img_align_celeba/data/%s" % opt.dataset_name, transforms_=transforms_, mode='val'),
